...
const { getAccessTokenForRegistration, verifyToken } = require('./auth')
...
router.use('/role', getAccessTokenForRegistration, require('./apis/role'))
router.use('/user', getAccessTokenForRegistration, require('./apis/user'))
